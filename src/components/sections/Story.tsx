...
export default function Story() {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative min-h-screen w-full flex flex-col items-center justify-center bg-background py-32 px-6"
    >
      <div className="max-w-3xl mx-auto flex flex-col gap-12 md:gap-20 text-center">
